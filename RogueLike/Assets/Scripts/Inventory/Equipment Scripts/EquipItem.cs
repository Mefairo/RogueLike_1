...
public class EquipItem
{
    ...
    private void Equip(Player player, EquipSlot_UI equipSlot_UI)
    {
        ...
        UseEquip(player, true, itemData, equipSlot_UI);
    ...
    private void UnEquip(Player player, EquipSlot_UI equipSlot_UI)
    {
        ...
        UseEquip(player, false, itemData, equipSlot_UI);
    ...
    //Прошлая версия
    private void UseEquip1(Player player, bool equip, InventoryItemData itemData, EquipSlot_UI equipSlot_UI)
    {
    ...
    //Нынешняя версия
    private void UseEquip(Player player, bool equip, InventoryItemData itemData, EquipSlot_UI equipSlot_UI)
    {
        int itemTier = equipSlot_UI.AssignedInventorySlot.EquipSlot.ItemTier;
